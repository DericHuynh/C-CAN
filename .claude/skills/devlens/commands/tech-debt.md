...
5. **Meaning (when summaries exist):** `get_summaries` with `include: ["technical"]` for the worst offenders, to explain _why_ each is a problem concretely — don't read files.
