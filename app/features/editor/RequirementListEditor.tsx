...
import { ChoiceResourceSelect } from "./ChoiceResourceSelect";
import { LazySelect } from "@/features/editor/LazySelect";
              ...
              {req.type === "id" ? (
                <div className="flex flex-wrap items-end gap-2">
                  <div className="min-w-44 flex-1 space-y-1">
                    <Label>Choice</Label>
                    <ChoiceResourceSelect
                      choices={choices}
                      value={req.reqId ?? ""}
                      onChange={(reqId) => update(index, { reqId })}
                    />
                  </div>
