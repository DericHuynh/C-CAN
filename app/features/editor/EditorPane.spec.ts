...
function mount(props: { busy?: boolean; canSave?: boolean; focusOnOpen?: boolean } = {}) {
  const save = vi.fn();
  act(() =>
    root.render(
...
describe("editor form navigation", () => {
  it("keeps inline editing focus when its inspector opens on mobile", () => {
